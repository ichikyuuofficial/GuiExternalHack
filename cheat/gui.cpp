...
void gui::Render() noexcept
{
	...
	ImGui::Begin(
		"[ GUI ] External Hacks - Counter Strike Global Offensive",
		&isRunning,
	...
	// text color green
	ImGui::TextColored({ 0.0f, 1.0f, 0.0f, 1.0f }, "[+] FEATURES : ");
	ImGui::NewLine();
	
	ImGui::Checkbox("Radar", &globals::isRadar);
	ImGui::Checkbox("Bunny Hop", &globals::isBunnyHop);
	ImGui::Checkbox("No Recoil", &globals::isRecoil);
	
	ImGui::Checkbox("Aimbot", &globals::isAimbot);
	if (globals::isAimbot)
	{
		ImGui::Indent();
		ImGui::Checkbox("Trigger Bot", &globals::isTriggerbot);
		ImGui::Unindent();
	}
